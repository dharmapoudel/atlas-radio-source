...
1. Push this repo to `https://github.com/dharmapoudel/atlas-radio-source`.
2. In **Settings > Pages**, set the source to **Deploy from a branch**, branch `gh-pages`, folder `/ (root)`.

The catalog is published to `https://dharmapoudel.github.io/atlas-radio-source/catalog.v1.json`, which can be submitted to <bridgething.com/apps>
